...
export default component$(() => {
  ...
  return (
    <header class="sticky bg-slate-200 top-0 z-10 flex justify-between gap-8 h-28 min-h-28 md:h-20 md:min-h-20 w-full py-2 px-8 overflow-hidden">
      <a
        href="/"
      ...
      <nav class="flex flex-wrap lg:flex-nowrap gap-4 items-center justify-center content-center text-sky-900">
        <Cta
          href="/"
          typography={{
            size: "text-lg",
